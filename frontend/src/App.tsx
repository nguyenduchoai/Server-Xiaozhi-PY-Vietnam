    ...
    <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200 shadow-sm">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">XiaoZhi CE</span>
        </Link>
        <nav className="hidden md:flex items-center gap-8">
            <Link to="/asset-generator" className="flex items-center gap-1.5 text-sm font-semibold text-slate-600 hover:text-violet-600 transition-colors">
                <Wand2 className="w-3.5 h-3.5" />Assets
            </Link>
            <Link to="/tools/flasher" className="flex items-center gap-1.5 text-sm font-semibold text-slate-600 hover:text-violet-600 transition-colors">
                <Download className="w-3.5 h-3.5" />Flasher
            </Link>
        </nav>
        <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm font-medium text-slate-600 hover:text-violet-700">Đăng nhập</Link>
        </div>
      </div>
    </header>
