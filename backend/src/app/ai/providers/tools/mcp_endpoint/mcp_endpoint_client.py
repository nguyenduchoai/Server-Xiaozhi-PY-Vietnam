"""Định nghĩa client điểm kết nối MCP"""
...
class MCPEndpointClient:
    """Client điểm kết nối MCP để quản lý trạng thái và công cụ"""

    def __init__(self, conn: ConnectionHandler | None = None):
        self.conn = conn
    ...
    async def send_message(self, message: str):
        """Gửi thông điệp tới điểm kết nối MCP"""
        if self.websocket:
